...
N.ui.serverWidget.module = function () {
    ...
    this.FormPageLinkType = new PageLinkType();
    ...
    this.SublistType = new SublistType();
    ...
    this.FieldBreakType = new FieldBreakType();
    ...
    this.FieldLayoutType = new FieldLayoutType();
    ...
    this.FieldDisplayType = new FieldDisplayType();
    ...
    this.SublistDisplayType = new SublistDisplayType();
    ...
    this.LayoutJustification = new LayoutJustification();
    ...
    this.AssistantSubmitAction = new AssistantSubmitAction();
};

N.ui.serverWidget.objects = (function () {
    /**
     *
...
define([], function () {
    return new N.ui.serverWidget.module();
});